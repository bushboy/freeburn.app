...
import 'package:oxoo/screen/track_charts_screen.dart';
...
import 'artist_charts_page.dart';
import 'downloads_screen.dart';
import 'live_tv_details_screen.dart';
import 'live_tv_screen.dart';
import 'music_search.dart';
import 'reality_show/reality_show_details_screen.dart';
import 'reality_show_screen.dart';
...
class _LandingScreenState extends State<LandingScreen> with SingleTickerProviderStateMixin {
  ...
  List<String> _widgetTitle = [/*"Home", */"Music","Chart","Artists","Reality","Contests"];//, "Charts", "Favourite"];

  List<Widget> _widgetOptions = <Widget>[/*HomeScreen(),*/SearchPage(query: ''),TrackChartsPage(),ArtistChartsPage(),RealityShowScreen(),TvSeriesScreen()];// , MoviesScreen(), FavouriteScreen()];
    ...
    OneSignal.shared.setNotificationOpenedHandler((notification) {
      ...
      switch (type) {
        case "tv":
          ...
          break;
        //case "movie":
        //  Navigator.pushNamed(context, RealityShowDetailsScreen.route, arguments: {"movieID": id});
        //  break;
        case "reality":
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => RealityShowDetailsScreen(
                  seriesID: id,
                  isPaid: '',
                )),
          );
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: <BottomNavigationBarItem>[
          ...
          /*BottomNavigationBarItem(
            ...
            label: AppContent.reality,
          ),*/
          BottomNavigationBarItem(
            activeIcon: Image.asset(
              'assets/bottom_nav/icon_music_80.png',
              color: CustomTheme.primaryColorRed,
              scale: 3,
            ),
            icon: Image.asset(
            ...
            label: AppContent.music,
          ),
          BottomNavigationBarItem(
            activeIcon: Image.asset(
              'assets/bottom_nav/icon_chart.png',
              color: CustomTheme.primaryColorRed,
              scale: 3,
            ),
            icon: Image.asset(
            ...
            label: AppContent.chart,
          ),
          BottomNavigationBarItem(
            activeIcon: Image.asset(
              'assets/bottom_nav/icon_star.png',
              color: CustomTheme.primaryColorRed,
              scale: 3,
            ),
            icon: Image.asset(
            ...
            onTap: () {
              ...
              switch (index) {
                ...
                /*case 1:
                  ...
                  Navigator.pushNamed(context, RealityShowScreen.route,arguments: true);
                  break;
                case 2:
                  Navigator.pop(context);
