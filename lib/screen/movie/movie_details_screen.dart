                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => MovieDetailsVideoPlayerWidget(videoUrl: movieDetailsModel.fileUrl)));
                                  },
                                  child: Padding(
                              ...
                              if (isDownloadEnable)
                                Container(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(backgroundColor: CustomTheme.whiteColor,),
                                    child: Padding(
                                      padding: const EdgeInsets.symmetric(
                                ...
                                Container(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      ...
                                      await (Repository().addVote(authUser.userId,videoId));
                                      showShortToast(favouriteResponseModel != null ? "Vote added" : favouriteResponseModel!.message!);
                                      setState(() {});
                                    },
                                    style: ElevatedButton.styleFrom(backgroundColor: CustomTheme.whiteColor,),
                                    child: Padding(
