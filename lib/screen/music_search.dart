...
import 'package:oxoo/widgets/music/vote_button.dart';
import 'package:oxoo/widgets/music/miniplayer.dart';
import 'package:oxoo/widgets/music/search_bar.dart';
...
import 'package:oxoo/screen/music/artists.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  Future<void> fetchResults() async {
    ...
    final Map result = await MusicApi().fetchSongSearchResults(
      searchQuery: query == '' ? widget.query : query,
      count: 5,
    );
    ...
    */
    final List<Map> value =
    await MusicApi().fetchSearchResults(query == '' ? widget.query : query);
          ...
          children: [
            Expanded(
              child: Scaffold(
                ...
                backgroundColor: CustomTheme.primaryColorDark, //Colors.transparent,
                body: SearchBar(
                  isYt: false,
