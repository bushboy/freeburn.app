...
import '../../bloc/reality_show/reality_show_bloc.dart';
...
class RealityShowDetailsScreen extends StatefulWidget {
  final String? seriesID;
  final String? isPaid;
  const RealityShowDetailsScreen({Key? key, required this.seriesID, required this.isPaid}) : super(key: key);
  @override
  _RealityShowDetailsScreenState createState() => _RealityShowDetailsScreenState();
}

class _RealityShowDetailsScreenState extends State<RealityShowDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    printLog("_RealityShowDetailsScreenState");
    ...
    return Scaffold(
      ...
      body: BlocProvider<RealityShowBloc>(
        create: (BuildContext context) =>
        RealityShowBloc(Repository())..add(GetRealityShowEvent(seriesId: widget.seriesID, userId: authUser != null ? authUser!.userId.toString() : null)),
        child: BlocBuilder<RealityShowBloc, RealityShowState>(
          builder: (context, state) {
            if (state is RealityShowIsLoaded) {
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Navigator.push(context,MaterialPageRoute(builder: (builder) => PlansScreen()));
                      },
