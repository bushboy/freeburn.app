...
import '../../screen/reality_show/reality_show_details_screen.dart';
...
class RealityShowScreen extends StatefulWidget {
  static final String route = '/RealityShowScreen';

  @override
  _RealityShowScreenState createState() => _RealityShowScreenState();
}

class _RealityShowScreenState extends State<RealityShowScreen> {
  ...
  Widget build(BuildContext context) {
    printLog("_RealityShowScreenState");
      ...
      body: Container(
        ...
        child: PagewiseGridView.count(
            ...
            pageFuture: (pageIndex) {
              ...
              return Repository().getAllRealityShows(pageNumber).then((value) => value!);
            }),
      ),
  ...
  _buildAppBar(isFromMenu) {
    if (isFromMenu)
      return AppBar(
        ...
        title: Text(AppContent.realityScreen),
      );
  }
