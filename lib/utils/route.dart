...
import '../../screen/reality_show_screen.dart';
...
import '../app.dart';
import '../screen/subscription/payment_screen.dart';
...
class Routes {
  ...
  static Map<String, WidgetBuilder> getRoute() {
    return <String, WidgetBuilder>{
      ...
      RealityShowScreen.route: (_) => RealityShowScreen(),
      ...
      PlansScreen.route: (_) => PlansScreen(),
      ...
      //RealityShowDetailsScreen.route: (_) => RealityDetailsDetailsScreen(),
